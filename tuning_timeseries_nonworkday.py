...
class Tuning_model(object):
    ...
    def lgb_val(self, params, train_set, past): 
        ...
        for j in range(1,9): # 8개
            ...
            x_train, y_train = trans(target_sub, 0, train_split, past_n, j, x_columns, y_columns)
            x_val, y_val = trans(target_sub, train_split, None, past_n, j, x_columns, y_columns)
        ...
        return {'loss': np.mean(losses_n,axis=0),'params':params ,'status': STATUS_OK}
